...
**Are you on mobile?** <a href="./MOBILE.MD">CLICK HERE</a>
...
**THIS PROJECT WILL NO LONGER BE WORKED ON FOR THE TIME BEING.** My tutorial will stay online as is for all to see and reference. Once I am capable of working on this tutorial again, I intend to finish, at a minimum, the basic uses for each function (specifically need to use Destroy() and findByPk()) and create/use the two other kinds of associations (manyToOne and manyToMany). Thank you to everyone for providing constructive criticisms and feedback. 
...
<a name="add-del-data"><img height="200px" src="photos/add-delete-data.png" /></a>
...
<img height="200px" src="photos/postico-no-two-favs.png" />
...
<img height="400px" src="photos/no-two-favorites.png" />
...
<img height="400px" src="photos/app-favorites.png" />
...
<img height="400px" src="photos/app-favs.png" />
...
<a name="del-assoc"><img height="200px" src="photos/delete-associations.png" /></a>
...
<img height="400px" src="photos/postico-favs.png" />
...
<img height="400px" src="photos/back-user-favs.png" />
...
<img height="400px" src="photos/front-fav-fetch.png" />
...
<img height="400px" src="photos/front-fav-render.png" /> 
...
<img height="150px" src="photos/front-del-click.png" />
...
<img height="150px" src="photos/app-del-click.png" />
